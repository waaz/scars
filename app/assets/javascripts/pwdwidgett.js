...
function _MakePWDWidget()
{
	...
	code += "<input type='password' class='pwdfield' name='"+pwdname+"' id='"+this.pwdfieldid+"' autocomplete='off'>";

	this.pwdtxtfield=pwdname+"_text";

	this.pwdtxtfieldid = this.pwdtxtfield+"_id";

	code += "<input type='text' class='pwdfield' name='"+this.pwdtxtfield+"' id='"+this.pwdtxtfieldid+"' style='display: none;' autocomplete='off'>";

	this.pwdshowdiv = pwdname+"_showdiv";

	this.pwdshow_anch = pwdname + "_show_anch";

	code += "<div class='pwdopsdiv' id='"+this.pwdshowdiv+"'><a href='javascript:void(0)' id='"+this.pwdshow_anch+"'>"+this.txtShow+"</a></div>";
